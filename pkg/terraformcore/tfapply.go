...
func (po *ApplyOptions) GetArgRefreshOnly() []string {
	if po.RefreshOnly {
...
func (po *ApplyOptions) GetArgTerraformVarFiles() []string {
	var args []string
...
func (po *ApplyOptions) GetArgVars() []string {
	var args []string
...
func (po *ApplyOptions) GetArgAutoApprove() []string {
	if po.AutoApprove {
